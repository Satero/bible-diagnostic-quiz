...
const QUESTIONS = [
  ...
  { id: 3, category: "Pentateuch", prompt: "God changed Abram's name to Abraham as part of a covenant promising he would become the father of what?", answer: "A multitude of nations (Genesis 17)", accepted: ["Many nations"] },
  { id: 4, category: "Pentateuch", prompt: "Which of Jacob's sons was sold into slavery by his brothers and later rose to power in Egypt?", answer: "Joseph (Genesis 37-50)" },
  ...
  { id: 8, category: "Pentateuch", prompt: "Israel wandered in the wilderness for 40 years largely because of their unbelief after the report of the twelve ___.", answer: "Spies (Numbers 13-14)" },
  ...
  { id: 16, category: "Historical Books", prompt: "Who was Israel's first king, anointed by the prophet Samuel?", answer: "Saul (1 Samuel 9-10)" },
  { id: 17, category: "Historical Books", prompt: "David became famous for defeating which Philistine giant in single combat?", answer: "Goliath (1 Samuel 17)" },
  { id: 18, category: "Historical Books", prompt: "Which king, known for God-given wisdom, built the first temple in Jerusalem?", answer: "Solomon (1 Kings 6-8)" },
  { id: 19, category: "Historical Books", prompt: "After Solomon's reign, the kingdom of Israel split into two kingdoms — name both.", answer: "Israel (north) and Judah (south) (1 Kings 12)", accepted: ["Israel and Judah", "Northern kingdom and southern kingdom"] },
  ...
  { id: 24, category: "Historical Books", prompt: "What role did Esther hold in the Persian court that allowed her to save the Jewish people from Haman's plot?", answer: "Queen (of Persia) (Esther 2)", accepted: ["She became queen"] },
  ...
  { id: 26, category: "Wisdom & Poetry", prompt: "At the end of Job, God responds to Job's suffering mainly by pointing to his own power and wisdom displayed in what?", answer: "Creation (Job 38-41)", accepted: ["Nature", "The created world"] },
  ...
  { id: 29, category: "Wisdom & Poetry", prompt: "Proverbs, a book of practical wisdom for godly living, is largely attributed to which king?", answer: "Solomon (Proverbs 1:1)" },
  ...
  { id: 35, category: "Wisdom & Poetry", prompt: "'For everything there is a season, and a time for every matter under heaven' is found in which book?", answer: "Ecclesiastes (Ecclesiastes 3:1)" },
  ...
  { id: 43, category: "Prophets", prompt: "The book of Hosea uses the prophet's own troubled marriage as a picture of what?", answer: "Israel's unfaithfulness to God (Hosea 1-3)", accepted: ["Israel's idolatry", "Spiritual unfaithfulness"] },
  { id: 44, category: "Prophets", prompt: "Joel's prophecy about a locust plague ultimately points forward to a future outpouring of what?", answer: "God's Spirit (Joel 2)", accepted: ["The Holy Spirit"] },
  ...
  { id: 54, category: "Gospels", prompt: "The parable of the Prodigal Son is found in which Gospel?", answer: "Luke (Luke 15)" },
  ...
  { id: 64, category: "Acts & Early Church", prompt: "On the day of Pentecost, what dramatic sign accompanied the Holy Spirit coming upon the apostles?", answer: "Tongues of fire (and the sound of a rushing wind) (Acts 2)", accepted: ["Tongues of fire", "Wind and fire"] },
  ...
  { id: 66, category: "Acts & Early Church", prompt: "Saul of Tarsus was dramatically converted on the road to what city?", answer: "Damascus (Acts 9)" },
  { id: 67, category: "Acts & Early Church", prompt: "After his conversion, Saul became known by what missionary name?", answer: "Paul (Acts 13)" },
  ...
  { id: 71, category: "Acts & Early Church", prompt: "The book of Acts ends with Paul under house arrest in what city, still preaching?", answer: "Rome (Acts 28)" },
  { id: 72, category: "Acts & Early Church", prompt: "Who vouched for Paul to the suspicious Jerusalem church and partnered with him in early missionary work?", answer: "Barnabas (Acts 9)" },
  { id: 73, category: "Acts & Early Church", prompt: "The early Jerusalem believers were noted for sharing possessions, fellowship, prayer, and what apostolic activity?", answer: "The apostles' teaching (Acts 2)", accepted: ["Teaching"] },
  ...
  { id: 81, category: "Epistles", prompt: "Colossians describes Christ as 'the image of the invisible God,' in whom all things ___.", answer: "Hold together (Colossians 1:17)", accepted: ["Consist"] },
  { id: 82, category: "Epistles", prompt: "1 & 2 Thessalonians deal significantly with the return of Christ and hope for believers who have done what?", answer: "Died (1 Thessalonians 4)", accepted: ["Fallen asleep", "Passed away"] },
  { id: 83, category: "Epistles", prompt: "1 Timothy gives Timothy instructions for organizing the church in Ephesus, including qualifications for elders/overseers and what other church office?", answer: "Deacons (1 Timothy 3)" },
  ...
  { id: 85, category: "Epistles", prompt: "James emphasizes that genuine faith is shown by what, not just belief?", answer: "Works (James 2)", accepted: ["Actions", "Deeds"] },
  ...
  { id: 101, category: "Epistles", prompt: "2 Timothy, Paul's final letter written from prison shortly before his death, is famous for declaring that all ___ is breathed out by God and profitable for teaching.", answer: "Scripture (2 Timothy 3:16)" },
  { id: 102, category: "Epistles", prompt: "Titus was left in Crete to appoint elders and combat false teachers; the letter especially emphasizes that good works should flow from what?", answer: "God's grace (Titus 2:11-14; 3:4-8)", accepted: ["Grace"] },
  ...
  { id: 89, category: "Revelation & Famous Verses", prompt: "Revelation opens with letters addressed to how many churches, located in what region?", answer: "Seven churches in Asia Minor (Revelation 2-3)", accepted: ["7 churches"] },
  { id: 90, category: "Revelation & Famous Verses", prompt: "Revelation's central hope in its closing chapters is a new heaven and new earth where God does what?", answer: "Dwells with his people (Revelation 21-22)", accepted: ["Lives with his people"] },
